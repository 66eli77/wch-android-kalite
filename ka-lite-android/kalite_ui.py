...
class KaliteUI(object):
	def __init__(self, kaliteApp):
		...
		logo_img = Image(source='horizontal-logo.png')
		#logo_img.pos_hint={'center_x': 0.1, 'center_y': .5}
		logo_houlder.padding = [20,10,Window.width-250,0]
		logo_houlder.add_widget(logo_img)

		self.root_layout.add_widget(logo_houlder)

		#create BubbleButtons
		self.content_reload_btn= Button(text='Reload Content', font_size=30
		    , color=(0.878, 0.941, 0.784, 1), bold=True)
		...
		buttons_holder.padding = [310,10,310,10]
